...
public class RingtoneFragment extends Fragment {
    ...
    public static RingtoneFragment newInstance(String param1, SongsAndRingtones songs){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Toast.makeText(getActivity(), "RingTones TrackFragment", Toast.LENGTH_SHORT).show();
